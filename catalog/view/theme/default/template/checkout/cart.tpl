...
<div class="content">
    ...
    <table class="radio">
        ...
        <?php if($my_custom_discount_status) {?>
        <tr class="highlight">
            <td><?php if ($next == 'my_custom_discount') { ?>
                <input type="radio" name="next" value="my_custom_discount" id="use_my_custom_discount" checked="checked" />
                <?php } else { ?>
                <input type="radio" name="next" value="my_custom_discount" id="use_my_custom_discount" />
                <?php } ?>
            </td>
            <td><label for="use_my_custom_discount">Use My Custom Discount</label></td>
        </tr>
        <?php }?>
...
<div class="cart-module">
    ...
    <div id="my_custom_discount" class="content" style="display: <?php echo ($next == 'my_custom_discount' ? 'block' : 'none') ?>;">
        <form action="<?php echo $action ?>" method="post" enctype="multipart/form-data">

            <input type="text" name="my_custom_discount" value="<?php echo isset($my_custom_discount) ? $my_custom_discount : '' ?>" />
            <input type="hidden" name="next" value="my_custom_discount" />
            &nbsp;
            <input type="submit" value="My Custom Discount" class="button" />
        </form>
    </div>
</div>
<?php } ?>
