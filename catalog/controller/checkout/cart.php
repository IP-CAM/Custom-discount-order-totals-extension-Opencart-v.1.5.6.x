...
class ControllerCheckoutCart extends Controller {
	...
	public function index() {
        ...
        // @start: My Custom Discount: When set by Customer
        if (isset($this->request->post['my_custom_discount'])) {

            $this->session->data['my_custom_discount'] = $this->request->post['my_custom_discount'];
            $this->session->data['success'] = $this->language->get('text_my_custom_discount');

            $this->redirect($this->url->link('checkout/cart'));
        }
        // @end: My Custom Discount: When set by Customer
		...
		if ($this->cart->hasProducts() || !empty($this->session->data['vouchers'])) {
            ...
            // @start: My Custom Discount: Retrieve setting.
            $this->data['my_custom_discount_status'] = $this->config->get('my_custom_discount_status');

            if (isset($this->request->post['my_custom_discount'])) {
                $this->data['my_custom_discount'] = $this->request->post['my_custom_discount'];
            } elseif (isset($this->session->data['my_custom_discount'])) {
                $this->data['my_custom_discount'] = $this->session->data['my_custom_discount'];
            } else {
                $this->data['my_custom_discount'] = '';
            }
            // @end: My Custom Discount: Retrieve setting.
